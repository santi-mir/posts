...
The fair data principles focus on aspects that are critical in research: data should be _reusable_. Also _reproducible_ and _transparent_ but the former implicitly includes these.
