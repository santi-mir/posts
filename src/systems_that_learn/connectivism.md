...
Connectivism[^connectivism_siemens] is a learning theory where the central object of the theory are **networks**.
...
Discussion on whether _all_ networks really learn are left for the next post. This one focuses on learning-human-networks and how the theory can help understand and design them.
